...
(function(mod) {
  ...
  function syncScroll(dv, type) {
    ...
    // Don't take action if the position of this editor.md was recently set
  ...
  // Updating the marks for editor.md content
  ...
  // Updating the gap between editor.md and original
